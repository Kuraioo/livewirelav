@section('title') Data Posts - Belajar Livewire 3 di XII RPL @endsection <div class="container mt-5 mb-5">
    <div class="row">
      <div class="col-md-12">
        <!-- flash message --> @if (session()->has('message')) <div class="alert alert-success">
          {{ session('message') }}
        </div> @endif
        <!-- end flash message -->
          ...
          <div class="card-body">
            <table class="table table-bordered">
              ...
              <tbody> @forelse ($posts as $post) <tr>
                ...
                </tr> @empty <div class="alert alert-danger"> Data Post belum Tersedia. </div> @endforelse </tbody>
            </table>
